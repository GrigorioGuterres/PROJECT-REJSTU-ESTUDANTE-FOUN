...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-primary shadow text-white p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Form Dadus Estudante</h4>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-n_emis"  value="<?php  echo $this->set_field_value('n_emis',""); ?>" type="number" placeholder="Enter N Emis" step="1"  required="" name="n_emis"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-f_moris"  value="<?php  echo $this->set_field_value('f_moris',""); ?>" type="text" placeholder="Enter F Moris"  required="" name="f_moris"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <div class="dropzone required" input="#ctrl-img_estudante" fieldname="img_estudante"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" extensions=".jpg,.png,.gif,.jpeg" filesize="3" maximum="1">
                                                                        <input name="img_estudante" id="ctrl-img_estudante" required="" class="dropzone-input form-control" value="<?php  echo $this->set_field_value('img_estudante',""); ?>" type="text"  />
                                                        ...
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-eskola_anterior"  value="<?php  echo $this->set_field_value('eskola_anterior',""); ?>" type="text" placeholder="Enter Eskola Anterior"  required="" name="eskola_anterior"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-group ">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <div class="">
                                                                            <input id="ctrl-pai"  value="<?php  echo $this->set_field_value('pai',""); ?>" type="text" placeholder="Enter Pai"  required="" name="pai"  class="form-control " />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group ">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="">
                                                                                <input id="ctrl-mae"  value="<?php  echo $this->set_field_value('mae',""); ?>" type="text" placeholder="Enter Mae"  required="" name="mae"  class="form-control " />
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <div class="">
                                                                                    <select required=""  id="ctrl-id_municipiu" data-load-select-options="id_postu" name="id_municipiu"  placeholder="Select a value ..."    class="custom-select" >
                                                                                        <option value="">Hili Municipio ...</option>
                                                                                        <?php 
                                                                    ...
                                                                    <div class="form-group ">
                                                                        <div class="row">
                                                                            <div class="col-sm-4">
                                                                                <label class="control-label" for="id_postu">Postu <span class="text-danger">*</span></label>
                                                                            </div>
                                                                            <div class="col-sm-8">
                                                                                <div class="">
                                                                    ...
                                                                    <div class="form-group ">
                                                                        <div class="row">
                                                                            <div class="col-sm-4">
                                                                                <label class="control-label" for="id_suco">Suco <span class="text-danger">*</span></label>
                                                                            </div>
                                                                            <div class="col-sm-8">
                                                                                <div class="">
                                                                    ...
                                                                    <div class="form-group ">
                                                                        <div class="row">
                                                                            <div class="col-sm-4">
                                                                                <label class="control-label" for="id_aldeia"> Aldeia <span class="text-danger">*</span></label>
                                                                            </div>
                                                                            <div class="col-sm-8">
                                                                                <div class="">
                                                                    ...
                                                                    <div class="form-group ">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <div class="">
                                                                                    <input id="ctrl-n_kontaktu"  value="<?php  echo $this->set_field_value('n_kontaktu',""); ?>" type="text" placeholder="Enter N Kontaktu"  required="" name="n_kontaktu"  class="form-control " />
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
