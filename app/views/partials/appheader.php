<div id="topbar" class="navbar navbar-expand-md fixed-top navbar-light" style="background: rgb(36,190,80);
background: -moz-linear-gradient(161deg, rgba(36,190,80,1) 18%, rgba(88,36,190,1) 99%);
background: -webkit-linear-gradient(161deg, rgba(36,190,80,1) 18%, rgba(88,36,190,1) 99%);
background: linear-gradient(161deg, rgba(36,190,80,1) 18%, rgba(88,36,190,1) 99%);
filter: progid:DXImageTransform.Microsoft.gradient(startColorstr="#24be50",endColorstr="#5824be",GradientType=1);">
    <div class="container-fluid">
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">
                            ...
                            if(!empty(USER_PHOTO)){
                            ?>
                            <img class="img-fluid" style="height:20px;" src="<?php print_link(set_img_src(USER_PHOTO,30,30)); ?>" />
                                <?php
                                }
                                else{
                                ?>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="<?php print_link('index/logout?csrf_token=' . Csrf::$token) ?>"><i class="material-icons">exit_to_app</i> <b>Sai Sistema</b></a>
                            </ul>
                        </li>
                    </ul>
                </div>
        ...
        if(user_login_status() == true ){ 
        ?>
        <nav id="sidebar" class="navbar-light bg-secondary">
